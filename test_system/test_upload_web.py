...
def test_upload_via_web():
    """Test upload file thông qua web interface"""
    
    app_url = "http://localhost:2701"
    
    print(f"Đang test upload file thông qua web interface tại {app_url}...")
...
def main():
    print("===== TEST UPLOAD FILE THÔNG QUA WEB INTERFACE =====")
    success = test_upload_via_web()
