-- Hệ thống Tăng Tốc hoàn toàn độc lập - Sửa lỗi xung đột
...
-- Bảng lưu các đáp án chấp nhận thêm cho mỗi câu hỏi Tăng Tốc (giống answers của khoidong)
...
CREATE INDEX IF NOT EXISTS idx_tangtoc_answers_question ON tangtoc_answers(question_id);
